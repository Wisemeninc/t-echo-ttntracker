...
// TTN Console shows: 34 53 49 05 09 34 50 34
uint64_t joinEUI = 0x3453490509345034;

// DevEUI - 8 bytes as shown in TTN Console (MSB format)
// TTN Console shows: 70 B3 D5 7E D0 07 4E 76
uint64_t devEUI = 0x70B3D57ED0074E76;

// AppKey - 16 bytes in MSB format (as shown in TTN Console)
uint8_t appKey[16] = {
    0xF4, 0x95, 0x0A, 0xCA, 0x94, 0x2D, 0x56, 0x5B,
    0x38, 0xFD, 0xCA, 0x27, 0x40, 0x75, 0x79, 0x33
};

// Network Key - For LoRaWAN 1.1.x (separate from AppKey)
uint8_t nwkKey[16] = {
    0x28, 0x7D, 0x32, 0x99, 0xF2, 0xD5, 0x00, 0x4E,
    0x78, 0x17, 0xF4, 0xA6, 0xC6, 0x43, 0x67, 0xE4
};
